...
import (
	...
	"ntq.project/project.test/restapi/operations/user"

	"github.com/rs/cors"
)

//go:generate swagger generate server --target ..\..\project.test --name CRM --spec ..\swagger.json --principal interface{}

func configureFlags(api *operations.CRMAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.CRMAPI) http.Handler {
